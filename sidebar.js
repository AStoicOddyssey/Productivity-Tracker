...
function buildSidebar(activePage, me, branches = []) {
  ...
  const html = `
    ...
    <nav class="nav">
      ...
      <div class="nav-folder" id="folder-work" style="display:none;">
        ...
        <a class="nav-item ${activePage === 'finance' ? 'active' : ''}" href="/finance">
      ...
      <button class="nav-folder-header" onclick="toggleFolder('folder-uni')">
        <svg class="folder-chevron" id="chev-folder-uni" viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg>
        <span>Uni</span>
      </button>
      <div class="nav-folder" id="folder-uni" style="display:none;">
        <a class="nav-item ${activePage === 'uni' ? 'active' : ''}" href="/uni">
          <svg viewBox="0 0 24 24"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c0 2 2 3 6 3s6-1 6-3v-5"/></svg>
          University Calendar
        </a>
        <a class="nav-item ${activePage === 'timetable' ? 'active' : ''}" href="/timetable">
          <svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="8" y1="14" x2="13" y2="14"/><line x1="8" y1="18" x2="11" y2="18"/></svg>
          Timetable
        </a>
